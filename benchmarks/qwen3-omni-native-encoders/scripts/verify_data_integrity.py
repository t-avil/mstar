...
Checks:
  ...
  - For systems with raw datapoints (mstar_old, mstar_new_chunked),
    datapoint counts match aggregate 'completed' counts
  - All JCTs are positive

Note: vLLM and mstar_new aggregates were ingested from harness summaries
without per-request raw datapoints — this is expected and not flagged.
"""
