...
def test_steady_decode_byte_identical():
    ...
    for rec in records[1:]:
        for _, new_tokens, items, boundary in rec.entries:
...
# NOTE(eiv2 port): test_fast_send_flag_invariant_on_sidecar_path removed — MSTAR_FAST_SEND is not ported to this branch (excluded experiment)
